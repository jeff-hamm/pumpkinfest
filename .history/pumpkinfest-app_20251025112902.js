...
class PumpkinfestRSVP {
    ...
    handlePumpkinPatchChange(event) {
        ...
        if (event.target.checked) {
            // If checked, hide the date options
            ...
            // If unchecked, show the date options
    ...
    resetForm() {
        ...
        // Reset pumpkin patch checkbox to checked and hide dates
        document.getElementById('pumpkin-patch').checked = true;
