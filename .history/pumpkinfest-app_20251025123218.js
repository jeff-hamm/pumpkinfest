...
An invalid form control with name='guestName' is not focusable. <input type=​"text" id=​"guest-name" name=​"guestName" required placeholder=​"Enter your name..." style=​"display:​ none;​ margin-top:​ 8px;​">​Understand this error            // Try fetch first, then fallback to JSONP if CORS fails
            let result;
            try {
